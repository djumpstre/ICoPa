...
#   quic/  -> inter-router link (QUIC+TLS, port 9099)
#   udp/   -> client-to-router link (UDP, port 7447)
# LISTEN_EP="${LISTEN_EP:-[\"quic/0.0.0.0:9099\", \"quic/0.0.0.0:7447\"]}"
LISTEN_EP="${LISTEN_EP:-[\"quic/0.0.0.0:9099\", \"quic/0.0.0.0:7447\", \"tcp/0.0.0.0:7448\"]}"
