...
ROUTER_ENDPOINT="${ROUTER_ENDPOINT:-tcp/0.0.0.0:7447}"
HOST_CONFIG_FILE="${HOST_CONFIG_FILE:-$SCRIPT_DIR/icopa_rtt_m.yaml}"
...
export ZENOH_SESSION_CONFIG_URI=/tmp/zenoh_client.json
